...
public class MainActivity extends AppCompatActivity {
    ...
    EmotionServiceClient restClient = new EmotionServiceRestClient("32fb6d7ec960401fbe338bbcd1341388");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == REQUEST_PERMISSION_CODE)
        {
            if(grantResults[0] == PackageManager.PERMISSION_GRANTED)
                Toast.makeText(this, "Oermission Granted", Toast.LENGTH_SHORT).show();
            else
        ...
        AsyncTask<InputStream,String,List<RecognizeResult>>processAsync = new AsyncTask<InputStream, String, List<RecognizeResult>>() {
            ...
            protected void onPostExecute(List<RecognizeResult> recognizeResults) {
                ...
                for(RecognizeResult res : recognizeResults)
                {
                    ...
                    imageView.setImageBitmap(ImageHelper.drawReactOnBitmap(mBitmap,res.faceRectangle,status));
                }
            }
        };
